...
As shown in Figure \ref{fig:main-stages}, the documentation system is divided in three different processes, each of them covering a major area when dealing with documentation and information. In order and in a more detailed glance:
